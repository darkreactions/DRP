...
class MaxMinValueValidation(DRPTestCase):
  ...
  def test_numeric_ok(self): 
    ...
    desc = NumMolDescriptor(heading='heading', name='test descriptor', calculatorSoftware='test suite', calculatorSoftwareVersion=0, maximum=5, minimum=3) 
    desc.save()
    descVal = NumMolDescriptorValue(compound=Compound.objects.get(label='EtOH'), descriptor=desc, value=3)
    descVal.save()
    descVal.delete()
    desc.delete()
  ...
  def test_numeric_toohigh(self):
    ...
    desc.save()
    with self.assertRaises(ValidationError)
      descVal = NumMolDescriptorValue(compound=Compound.objects.get(label='EtOH'), descriptor=desc, value=6)
      descVal.save()
    descVal.delete()
    desc.delete()
  ...
  def test_numeric_loolow(self):
    ...
    desc.save()
    with self.assertRaises(ValidationError)
      descVal = NumMolDescriptorValue(compound=Compound.objects.get(label='EtOH'), descriptor=desc, value=2)
      descVal.save()
    descVal.delete()
    desc.delete()
  ...
  def test_ordinal_ok(self): 
    ...
    desc = OrdMolDescriptor(heading='heading', name='test descriptor', calculatorSoftware='test suite', calculatorSoftwareVersion=0, maximum=5, minimum=3) 
    desc.save()
    descVal = OrdMolDescriptorValue(compound=Compound.objects.get(label='EtOH'), descriptor=desc, value=3)
    descVal.save()
    descVal.delete()
    desc.delete()
  ...
  def test_ordinal_toohigh(self):
    ...
    desc.save()
    with self.assertRaises(ValidationError)
      descVal = OrdMolDescriptorValue(compound=Compound.objects.get(label='EtOH'), descriptor=desc, value=6)
      descVal.save()
    descVal.delete()
    desc.delete()
  ...
  def test_ordinal_loolow(self):
    ...
    desc.save()
    with self.assertRaises(ValidationError)
      descVal = OrdMolDescriptorValue(compound=Compound.objects.get(label='EtOH'), descriptor=desc, value=2)
      descVal.save()
    descVal.delete()
    desc.delete()
...
class CategoricalValidation(DRPTestCase):
  ...
  def setUp(self):
    ...
    self.desc.save()
    self.descPerm = CatMolDescriptorPermitted(descriptor=self.desc, value='fun')
    self.descPerm.save()
    self.descPerm2 = CatMolDescriptorPermitted(descriptor=self.desc, value='dull')
    self.descPerm2.save()
    self.descPerm3 = CatMolDescriptorPermitted(descriptor=self.desc2, value='banana')
    self.descPerm3.save()
