...
class CompoundFilterFormSucceed(BaseFormTest):
    ...
    def setUpFormData(self):
        ...
        self.formData["name"] =	"1-aminomehtyl-1-ethylpyrrolidine"
        self.formData["chemicalClasses"] =	"Amine"
        ...
        self.formData["labgroup"] = "GalaxyGuardians" 
...
class CompoundFilterFormDifferentLabGroupSucceed(BaseFormTest):
    ...
    def test_fetch(self):
        fetched = self.form.fetch()
        self.assertEqual(fetched, 0, "Expected 0 objects. Number of objects returned was {}".format(fetched.count()))
...
suite = unittest.TestSuite([
          ...
          loadTests(CompoundFilterFormDifferentLabGroupSucceed),
