...
class CompoundFilterSetSucceed(BaseFormTest):
    ...
    def setUpFormData(self):
        self.formData = {}
        self.formData["id_form-TOTAL_FORMS"] = 3
        self.formData["id_form-INITIAL_FORMS"] = 0
        self.formData["id_form-MAX_NUM_FORMS"] = 10000
        #first form
        self.formData["id_form-0-abbrevs"] = "2-amep"
        self.formData["id_form-0-name"] =	"2-aminomethyl-1-ethylpyrrolidine"
        self.formData["id_form-0-chemicalClasses"]= [self.chemicalClass.pk]
        self.formData["id_form-0-CSID"] = "104820"
        self.formData["id_form-0-INCHI"] = "InChI=1S/C7H16N2/c1-2-9-5-3-4-7(9)6-8/h7H,2-6,8H2,1H3"
        self.formData["id_form-0-smiles"] = "CCN1CCCC1CN"
        self.formData["id_form-0-labGroup"] = self.labgroup.pk 
        self.formData["id_form-0-js_active"] = False
	    #second form 
        self.formData["id_form-1-abbrevs"] = "hmta"
        self.formData["id_form-1-name"] =	"1,3,5,7-tetraazaadamantane"
        self.formData["id_form-1-chemicalClasses"]= [self.chemicalClass.pk]
        self.formData["id_form-2-CSID"] = "3959"
        self.formData["id_form-2-INCHI"] = "InChI=1S/C6H12N4/c1-7-2-9-4-8(1)5-10(3-7)6-9/h1-6H2"
        self.formData["id_form-2-smiles"] = "C1N2CN3CN1CN(C2)C3"
        self.formData["id_form-1-labGroup"] = self.labgroup.pk 
        self.formData["id_form-1-js_active"] = False
        #third form 	
        self.formData["id_form-2-abbrevs"] = "sov"
        self.formData["id_form-2-name"] = "Sodium Orthovanadate"
        self.formData["id_form-2-chemicalClasses"]= [self.chemicalClass.pk]
        self.formData["id_form-2-CSID"] = "55575"
        self.formData["id_form-2-INCHI"] = "InChI=1S/3Na.4O.V/q3*+1;;3*-1;"
        self.formData["id_form-2-smiles"] = "[O-][V](=O)([O-])[O-].[Na+].[Na+].[Na+]"
        self.formData["id_form-2-labGroup"] = self.labgroup.pk 
        self.formData["id_form-2-js_active"] = False
    ...
    def test_fetch(self):
        ...
        self.assertEqual(fetched.count(), 3, "Got more than one result from the filter form")
