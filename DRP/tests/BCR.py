...
from decorators import createsPerformedReactionSet, createsPerformedReactionSetBool
...
class BCRWekaSVMBool(DRPTestCase):
...
suite = unittest.TestSuite([
          loadTests(BCRWekaSVM), loadTests(BCRWekaSVMBool)
          ])
