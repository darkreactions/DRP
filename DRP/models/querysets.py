...
class ArffQuerySet(models.query.QuerySet):
  ...
  def toArff(self, writeable, expanded=False, relationName='relation', whitelistDescriptors=None, missing="?"):
    ...
    for item in self:
      ...
      if expanded:
        ...
        writeable.write(','.join(str(item.values.get(key, missing)) for key in headers.keys()))
      writeable.write('\n')
