...
from DRP.models import PerformedReaction, BoolRxnDescriptorValue,\
    CatRxnDescriptorValue, CompoundQuantity,\
    Reaction, Compound, RecommendedReaction, LabGroup

headers_to_use = ['Pu_mols_DRP_0.02', 'Tb_mols_DRP_0.02', 'Lu_mols_DRP_0.02',
                  'Ru_mols_DRP_0.02', 'Ga_mols_DRP_0.02', 'Au_mols_DRP_0.02',
                  'B_mols_DRP_0.02', 'Li_mols_DRP_0.02', 'Ca_mols_DRP_0.02',
                  'Hf_mols_DRP_0.02', 'Pd_mols_DRP_0.02', 'In_mols_DRP_0.02',
                  'Org_mw_drp/rdkit_0_Range_DRP_DRP', 'Pr_mols_DRP_0.02',
                  'Ho_mols_DRP_0.02', 'Na_mols_DRP_0.02', 'Cu_mols_DRP_0.02',
                  'reaction_pH_manual_0', 'Po_mols_DRP_0.02', 'Org_mw_drp/rdkit_0_gmean_molarity_DRP_DRP',
                  'Zn_mols_DRP_0.02', 'Tm_mols_DRP_0.02', 'Inorg_mw_drp/rdkit_0_Range_DRP_DRP',
                  'H_mols_DRP_0.02', 'reaction_temperature_manual_0', 'At_mols_DRP_0.02',
                  'Te_mols_DRP_0.02', 'Rh_mols_DRP_0.02', 'Yb_mols_DRP_0.02',
                  'Inorg_amount_count_DRP_0.02', 'Pt_mols_DRP_0.02', 'Pm_mols_DRP_0.02',
                  'Sb_mols_DRP_0.02', 'Al_mols_DRP_0.02', 'F_mols_DRP_0.02', 'S_mols_DRP_0.02',
                  'Mn_mols_DRP_0.02', 'Cr_mols_DRP_0.02', 'Nd_mols_DRP_0.02', 'Co_mols_DRP_0.02',
                  'Fe_mols_DRP_0.02', 'C_mols_DRP_0.02', 'Os_mols_DRP_0.02', 'Ti_mols_DRP_0.02',
                  'Ir_mols_DRP_0.02', 'Si_mols_DRP_0.02', 'Re_mols_DRP_0.02', 'Ar_mols_DRP_0.02',
                  'Solv_amount_count_DRP_0.02', 'W_mols_DRP_0.02', 'Dy_mols_DRP_0.02',
                  'Y_mols_DRP_0.02', 'Cd_mols_DRP_0.02', 'Ce_mols_DRP_0.02',
                  'As_mols_DRP_0.02', 'Ag_mols_DRP_0.02', 'La_mols_DRP_0.02',
                  'U_mols_DRP_0.02', 'Np_mols_DRP_0.02', 'Eu_mols_DRP_0.02',
                  'Er_mols_DRP_0.02', 'K_mols_DRP_0.02', 'Pa_mols_DRP_0.02',
                  'Ni_mols_DRP_0.02', 'pH_amount_molarity_DRP_0.02', 'Ox_amount_molarity_DRP_0.02',
                  'N_mols_DRP_0.02', 'Am_mols_DRP_0.02', 'Tl_mols_DRP_0.02',
                  'Kr_mols_DRP_0.02', 'Inorg_mw_drp/rdkit_0_Max_DRP_DRP',
                  'Ra_mols_DRP_0.02', 'Org_amount_count_DRP_0.02', 'Se_mols_DRP_0.02',
                  'Be_mols_DRP_0.02', 'Th_mols_DRP_0.02', 'Inorg_mw_drp/rdkit_0_gmean_count_DRP_DRP',
                  'Mg_mols_DRP_0.02', 'Rn_mols_DRP_0.02', 'Tc_mols_DRP_0.02',
                  'Cl_mols_DRP_0.02', 'Sn_mols_DRP_0.02', 'Inorg_mw_drp/rdkit_0_gmean_molarity_DRP_DRP',
                  'Sc_mols_DRP_0.02', 'Ac_mols_DRP_0.02', 'Gd_mols_DRP_0.02', 'Xe_mols_DRP_0.02',
                  'Hg_mols_DRP_0.02', 'Ge_mols_DRP_0.02', 'Mo_mols_DRP_0.02', 'Cs_mols_DRP_0.02',
                  'Sr_mols_DRP_0.02', 'O_mols_DRP_0.02', 'Org_mw_drp/rdkit_0_gmean_count_DRP_DRP',
                  'Nb_mols_DRP_0.02', 'I_mols_DRP_0.02', 'Ta_mols_DRP_0.02', 'Fr_mols_DRP_0.02',
                  'Rb_mols_DRP_0.02', 'Ox_amount_count_DRP_0.02', 'pH_amount_count_DRP_0.02',
                  'Zr_mols_DRP_0.02', 'He_mols_DRP_0.02', 'Ne_mols_DRP_0.02',
                  'reaction_time_manual_0', 'Pb_mols_DRP_0.02', 'Br_mols_DRP_0.02',
                  'Inorg_amount_molarity_DRP_0.02', 'V_mols_DRP_0.02', 'Org_mw_drp/rdkit_0_Max_DRP_DRP',
                  'Bi_mols_DRP_0.02', 'Sm_mols_DRP_0.02', 'Solv_amount_molarity_DRP_0.02',
                  'Ba_mols_DRP_0.02', 'Org_amount_molarity_DRP_0.02', 'P_mols_DRP_0.02']
...
class Recommender(AbstractRecommender):
    # Reaction.objects.get(notes = 'Placeholder reaction')):
    def __init__(self, model_container, grid_params, desired_desc_dict, seed=None):
        """
        High level class for making recommendation. Takes a specific model, 
        parameters given from a gridparameter object, a dictionary of desired descriptors and an optional seed.
    ...
    def build_hash_outcome_dict(self):
        ...
        outcome_dict = {}
        count = 0
        # <<<< this is messed around with for debugging sake
        for rxn in PerformedReaction.objects.all()[:10]:
            count += 1
            try:
                # TODO TEST TO MAKE SURE HASH CATEGORICAL DESCRIPTOR PK DOesN'T CHANGE
                rxn_hash = CatRxnDescriptorValue.objects.get(
                    descriptor__pk=6793, reaction=rxn).value
            ...
            try:
                reaction_outcome = BoolRxnDescriptorValue.objects.get(
                    descriptor__pk=2, reaction=rxn)
    ...
    def get_mutual_info(self, outcome_dict):
        ...
        # <<<< problem here, outcomes isn't of correct shape
    ...
    def get_distance_dict(self, number_of_neighbors=20, normalize=True):
        ...
        for rxn, rxn_row in zip(self.plausible_reactions, self.plausible_reactions.rows(True)):
            ...
            dist_dict[rxn] = sum([query_result[1] for query_result in self.lshash.query(
                point, num_results=number_of_neighbors)])/number_of_neighbors
    ...
    def score_candidates(self):
        ...
        for rxn in self.plausible_reactions:
            rxn_hash = CatRxnDescriptorValue.objects.get(
                descriptor__pk=6793, reaction=rxn).value.value
            score_dict[rxn] = self.hash_MI[rxn_hash] * \
                dist_dict[rxn]  # *confidence
    ...
    def recommend(self, k=1000):
        ...
        compound_objects = Compound.objects.filter(pk__in=(
            CompoundQuantity.objects.exclude(amount=None).values_list('compound__pk', flat=True)))
        ...
        plausible_reaction_ids = [
            rxn.pk for rxn in self.plausible_reactions][0:100]

        print(("--- %s seconds ---" % (time.time() - start_time)))

        self.plausible_reactions = Reaction.objects.filter(
            pk__in=plausible_reaction_ids)

        self.sieve = ReactionSieve(
            self.model_container, self.desired_desc_dict)
