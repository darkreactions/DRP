...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-p', '--predictor-headers', nargs='+', default=descriptor_headers,
...
def prepare_build_model(predictor_headers=None, response_headers=None, modelVisitorLibrary=None, modelVisitorTool=None, splitter=None, training_set_name=None,
    ...
    if response_headers is not None:
        ...
        if responses.count() < len(response_headers):
            ...
            print("Warning: Found more response variables than headers... using manual headers")
            # TODO: there are two boolean_crystallisation_outcome descriptors in the DB, selecting manual ones since they are more complete
