...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerformedReaction.performedBy'
        db.add_column(u'DRP_performedreaction', 'performedBy',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='performedReactions', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerformedReaction.performedBy'
        db.delete_column(u'DRP_performedreaction', 'performedBy_id')
