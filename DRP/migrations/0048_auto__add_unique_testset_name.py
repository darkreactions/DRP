...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TestSet', fields ['name']
        db.create_unique(u'DRP_testset', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'TestSet', fields ['name']
        db.delete_unique(u'DRP_testset', ['name'])
