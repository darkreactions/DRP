...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompoundQuantity.reaction'
        db.alter_column(u'DRP_compoundquantity', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Reaction']))

        # Changing field 'CompoundQuantity.compound'
        db.alter_column(u'DRP_compoundquantity', 'compound_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Compound'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'CompoundQuantity.reaction'
        db.alter_column(u'DRP_compoundquantity', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Reaction'], on_delete=models.PROTECT))

        # Changing field 'CompoundQuantity.compound'
        db.alter_column(u'DRP_compoundquantity', 'compound_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Compound']))
