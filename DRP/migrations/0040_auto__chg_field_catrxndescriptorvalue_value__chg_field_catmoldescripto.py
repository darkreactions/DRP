...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CatRxnDescriptorValue.value'
        db.alter_column(u'DRP_catrxndescriptorvalue', 'value_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.CategoricalDescriptorPermittedValue'], null=True, on_delete=models.PROTECT))

        # Changing field 'CatMolDescriptorValue.value'
        db.alter_column(u'DRP_catmoldescriptorvalue', 'value_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.CategoricalDescriptorPermittedValue'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'CatRxnDescriptorValue.value'
        db.alter_column(u'DRP_catrxndescriptorvalue', 'value_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.CategoricalDescriptorPermittedValue'], null=True))
