...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'DRP_lab_group', (
            ...
            ('access_code', self.gf('django.db.models.fields.CharField')(default='hwXkT7CGGn9l2W86M04U', max_length=20)),
        ))
    ...
    models = {
        ...
        'DRP.lab_group': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'5YiV4cuaWZIF2SSg7yzG'", 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
