...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModelContainer.fully_trained'
        db.alter_column(u'DRP_modelcontainer', 'fully_trained_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ModelContainer.fully_trained'
        raise RuntimeError("Cannot reverse this migration. 'ModelContainer.fully_trained' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ModelContainer.fully_trained'
        db.alter_column(u'DRP_modelcontainer', 'fully_trained_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel']))
