...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compound.CSID'
        db.alter_column(u'DRP_compound', 'CSID', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Compound.CSID'
        raise RuntimeError("Cannot reverse this migration. 'Compound.CSID' and its values cannot be restored.")
