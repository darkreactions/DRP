...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'DRP_predordrxndescriptor', (
            ...
            ('model_container', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'])),
    ...
    models = {
        ...
        'DRP.legacystatsmodel': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'default': "'/home/casey/Projects/DRP/models/untitled.model'", 'max_length': '128'}),
        ...
        'DRP.predboolrxndescriptor': {
            ...
            'model_container': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.StatsModel']"}),
