...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Compound', fields ['labGroup', 'CSID']
        db.create_unique(u'DRP_compound', ['labGroup_id', 'CSID'])


    def backwards(self, orm):
        # Removing unique constraint on 'Compound', fields ['labGroup', 'CSID']
        db.delete_unique(u'DRP_compound', ['labGroup_id', 'CSID'])
