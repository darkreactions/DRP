...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='uid',
            field=models.CharField(default=DRP.models.molDescriptorValues.molUid,
                                   max_length=36, serialize=False, primary_key=True),
        ),
        migrations.AlterField(
            model_name='boolrxndescriptorvalue',
            name='uid',
            field=models.CharField(default=DRP.models.rxnDescriptorValues.rxnUid,
                                   max_length=36, serialize=False, primary_key=True),
        ),
        migrations.AlterField(
