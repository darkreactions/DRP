...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CatMolDescriptorPermitted.value'
        db.alter_column(u'DRP_catmoldescriptorpermitted', 'value', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
        # Adding unique constraint on 'CatMolDescriptorPermitted', fields ['value']
        db.create_unique(u'DRP_catmoldescriptorpermitted', ['value'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'CatMolDescriptorPermitted', fields ['value']
        db.delete_unique(u'DRP_catmoldescriptorpermitted', ['value'])


        # Changing field 'CatMolDescriptorPermitted.value'
        db.alter_column(u'DRP_catmoldescriptorpermitted', 'value', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'CatMolDescriptorValue.value'
        db.alter_column(u'DRP_catmoldescriptorvalue', 'value_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['DRP.CatMolDescriptorPermitted']))
    ...
    models = {
        ...
        'DRP.catmoldescriptorpermitted': {
            'Meta': {'unique_together': "(('descriptor', 'value'),)", 'object_name': 'CatMolDescriptorPermitted'},
        ...
        'DRP.catmoldescriptorvalue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.CatMolDescriptorPermitted']", 'null': 'True'})
        },
        'DRP.chemicalclass': {
