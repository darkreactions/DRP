...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.effectiveDate'
        db.add_column(u'DRP_license', 'effectiveDate',
                      self.gf('django.db.models.fields.DateField')(default='1960-01-01'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'License.effectiveDate'
        db.delete_column(u'DRP_license', 'effectiveDate')
