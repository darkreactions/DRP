...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PredOrdRxnDescriptor'
        db.create_table(u'DRP_predordrxndescriptor', (
            (u'ordrxndescriptor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DRP.OrdRxnDescriptor'], unique=True, primary_key=True)),
            ('stats_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'])),
            ('prediction_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='predition_of', to=orm['DRP.OrdRxnDescriptor'])),
        ))
        db.send_create_signal('DRP', ['PredOrdRxnDescriptor'])

        # Adding model 'PredNumRxnDescriptor'
        db.create_table(u'DRP_prednumrxndescriptor', (
            (u'numrxndescriptor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DRP.NumRxnDescriptor'], unique=True, primary_key=True)),
            ('stats_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'])),
            ('prediction_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prediction_of', to=orm['DRP.NumRxnDescriptor'])),
        ))
        db.send_create_signal('DRP', ['PredNumRxnDescriptor'])

        # Adding model 'ModelContainer'
        db.create_table(u'DRP_modelcontainer', (
            ...
            ('splitter', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('fully_trained', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'], null=True)),
        ))
        db.send_create_signal('DRP', ['ModelContainer'])

        # Adding model 'PredCatRxnDescriptor'
        db.create_table(u'DRP_predcatrxndescriptor', (
            (u'catrxndescriptor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DRP.CatRxnDescriptor'], unique=True, primary_key=True)),
            ('stats_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'])),
            ('prediction_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prediction_of', to=orm['DRP.CatRxnDescriptor'])),
        ))
        db.send_create_signal('DRP', ['PredCatRxnDescriptor'])

        # Adding model 'PredBoolRxnDescriptor'
        db.create_table(u'DRP_predboolrxndescriptor', (
            (u'boolrxndescriptor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DRP.BoolRxnDescriptor'], unique=True, primary_key=True)),
            ('stats_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'])),
            ('prediction_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prediction_of', to=orm['DRP.BoolRxnDescriptor'])),
        ))
        db.send_create_signal('DRP', ['PredBoolRxnDescriptor'])

        # Deleting field 'StatsModel.splitter'
        db.delete_column(u'DRP_statsmodel', 'splitter')

        # Deleting field 'StatsModel.tool'
        db.delete_column(u'DRP_statsmodel', 'tool')

        # Deleting field 'StatsModel.library'
        db.delete_column(u'DRP_statsmodel', 'library')

        # Adding field 'StatsModel.container'
        db.add_column(u'DRP_statsmodel', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.ModelContainer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PredOrdRxnDescriptor'
        db.delete_table(u'DRP_predordrxndescriptor')

        # Deleting model 'PredNumRxnDescriptor'
        db.delete_table(u'DRP_prednumrxndescriptor')

        # Deleting model 'ModelContainer'
        db.delete_table(u'DRP_modelcontainer')

        # Deleting model 'PredCatRxnDescriptor'
        db.delete_table(u'DRP_predcatrxndescriptor')

        # Deleting model 'PredBoolRxnDescriptor'
        db.delete_table(u'DRP_predboolrxndescriptor')


        # User chose to not deal with backwards NULL issues for 'StatsModel.splitter'
        raise RuntimeError("Cannot reverse this migration. 'StatsModel.splitter' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'StatsModel.tool'
        raise RuntimeError("Cannot reverse this migration. 'StatsModel.tool' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'StatsModel.library'
        raise RuntimeError("Cannot reverse this migration. 'StatsModel.library' and its values cannot be restored.")
        # Deleting field 'StatsModel.container'
        db.delete_column(u'DRP_statsmodel', 'container_id')
    ...
    models = {
        ...
        'DRP.modelcontainer': {
            ...
            'splitter': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'DRP.predboolrxndescriptor': {
            ...
            'prediction_of': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prediction_of'", 'to': "orm['DRP.BoolRxnDescriptor']"}),
            'stats_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.StatsModel']"})
        },
        'DRP.predcatrxndescriptor': {
            ...
            'prediction_of': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prediction_of'", 'to': "orm['DRP.CatRxnDescriptor']"}),
            'stats_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.StatsModel']"})
        },
        'DRP.prednumrxndescriptor': {
            ...
            'prediction_of': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prediction_of'", 'to': "orm['DRP.NumRxnDescriptor']"}),
            'stats_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.StatsModel']"})
        },
        'DRP.predordrxndescriptor': {
            ...
            'prediction_of': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'predition_of'", 'to': "orm['DRP.OrdRxnDescriptor']"}),
            'stats_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.StatsModel']"})
        },
        'DRP.reaction': {
        ...
        'DRP.testset': {
            ...
            'reactions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['DRP.PerformedReaction']", 'through': "orm['DRP.TestSetRelation']", 'symmetrical': 'False'})
        },
        'DRP.testsetrelation': {
            'Meta': {'unique_together': "(('test_set', 'reaction'),)", 'object_name': 'TestSetRelation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.PerformedReaction']", 'on_delete': 'models.PROTECT'}),
            'test_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.TestSet']"})
        },
        'DRP.trainingset': {
