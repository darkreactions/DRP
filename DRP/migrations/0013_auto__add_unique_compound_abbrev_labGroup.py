...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Compound', fields ['abbrev', 'labGroup']
        db.create_unique(u'DRP_compound', ['abbrev', 'labGroup_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Compound', fields ['abbrev', 'labGroup']
        db.delete_unique(u'DRP_compound', ['abbrev', 'labGroup_id'])
    ...
    models = {
        ...
        'DRP.compound': {
            ...
            'Meta': {'unique_together': "(('abbrev', 'labGroup'),)", 'object_name': 'Compound'},
