...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'DRP_performedreaction', 'duplicateOf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.PerformedReaction']))

    def backwards(self, orm):

        # Changing field 'PerformedReaction.duplicateOf'
        db.alter_column(u'DRP_performedreaction', 'duplicateOf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Reaction']))
