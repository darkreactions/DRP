...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MolDescriptor', fields ['heading']
        db.delete_unique(u'DRP_moldescriptor', ['heading'])


        # Changing field 'OrdMolDescriptor.minimum'
        db.alter_column(u'DRP_ordmoldescriptor', 'minimum', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'OrdMolDescriptor.maximum'
        db.alter_column(u'DRP_ordmoldescriptor', 'maximum', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding field 'CatMolDescriptorPermitted.value'
        db.add_column(u'DRP_catmoldescriptorpermitted', 'value',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=500),
                      keep_default=False)

        # Deleting field 'MolDescriptor.kind'
        db.delete_column(u'DRP_moldescriptor', 'kind')


    def backwards(self, orm):

        # Changing field 'OrdMolDescriptor.minimum'
        db.alter_column(u'DRP_ordmoldescriptor', 'minimum', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'OrdMolDescriptor.maximum'
        db.alter_column(u'DRP_ordmoldescriptor', 'maximum', self.gf('django.db.models.fields.IntegerField')(default=None))
        # Deleting field 'CatMolDescriptorPermitted.value'
        db.delete_column(u'DRP_catmoldescriptorpermitted', 'value')

        # Adding field 'MolDescriptor.kind'
        db.add_column(u'DRP_moldescriptor', 'kind',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20),
                      keep_default=False)

        # Adding unique constraint on 'MolDescriptor', fields ['heading']
        db.create_unique(u'DRP_moldescriptor', ['heading'])


    models = {
        'DRP.boolmoldescriptor': {
            'Meta': {'object_name': 'BoolMolDescriptor', '_ormbases': ['DRP.MolDescriptor']},
            u'moldescriptor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['DRP.MolDescriptor']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'DRP.catmoldescriptor': {
            'Meta': {'object_name': 'CatMolDescriptor', '_ormbases': ['DRP.MolDescriptor']},
            u'moldescriptor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['DRP.MolDescriptor']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'DRP.ordmoldescriptor': {
            'Meta': {'object_name': 'OrdMolDescriptor', '_ormbases': ['DRP.MolDescriptor']},
