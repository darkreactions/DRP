...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerformedReaction.duplicateOf'
        db.alter_column(u'DRP_performedreaction', 'duplicateOf_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['DRP.PerformedReaction']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PerformedReaction.duplicateOf'
        raise RuntimeError("Cannot reverse this migration. 'PerformedReaction.duplicateOf' and its values cannot be restored.")
