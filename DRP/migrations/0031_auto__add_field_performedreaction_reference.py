...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerformedReaction.reference'
        db.add_column(u'DRP_performedreaction', 'reference',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerformedReaction.reference'
        db.delete_column(u'DRP_performedreaction', 'reference')
