...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compound.abbrev'
        db.alter_column(u'DRP_compound', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CompoundQuantity.amount'
        raise RuntimeError("Cannot reverse this migration. 'CompoundQuantity.amount' and its values cannot be restored.")

        # Changing field 'Compound.abbrev'
        db.alter_column(u'DRP_compound', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'DRP.compound': {
            ...
            'abbrev': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
