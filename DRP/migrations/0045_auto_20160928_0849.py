...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            'CREATE TRIGGER soil_reaction BEFORE UPDATE ON DRP_compound FOR EACH ROW SET NEW.dirty = IF(OLD.calculating=1 and NEW.calculating=0, 0, 1), NEW.recalculate = OLD.calculating AND NEW.calculating AND (OLD.recalculate AND NEW.recalculate);',
