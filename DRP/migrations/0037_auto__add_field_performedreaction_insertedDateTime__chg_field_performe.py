...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerformedReaction.insertedDateTime'
        db.add_column(u'DRP_performedreaction', 'insertedDateTime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 9, 16, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'PerformedReaction.performedDateTime'
        db.alter_column(u'DRP_performedreaction', 'performedDateTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'PerformedReaction.insertedDateTime'
        db.delete_column(u'DRP_performedreaction', 'insertedDateTime')


        # User chose to not deal with backwards NULL issues for 'PerformedReaction.performedDateTime'
        raise RuntimeError("Cannot reverse this migration. 'PerformedReaction.performedDateTime' and its values cannot be restored.")
