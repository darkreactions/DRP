...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'DRP_compoundquantity', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))
        # Adding unique constraint on 'PerformedReaction', fields ['reference']
        #db.create_unique(u'DRP_performedreaction', ['reference'])


        # Changing field 'Compound.name'
        db.alter_column(u'DRP_compound', 'name', self.gf('django.db.models.fields.CharField')(max_length=400))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CompoundQuantity.amount'
        db.alter_column(u'DRP_compoundquantity', 'amount', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Compound.name'
        db.alter_column(u'DRP_compound', 'name', self.gf('django.db.models.fields.CharField')(max_length=300))
