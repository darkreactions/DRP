...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BoolMolDescriptorValue.descriptor'
        db.add_column(u'DRP_boolmoldescriptorvalue', 'descriptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.BoolMolDescriptor']),
                      keep_default=False)
        ...
        # Adding field 'NumMolDescriptorValue.descriptor'
        db.add_column(u'DRP_nummoldescriptorvalue', 'descriptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.BoolMolDescriptor']),
                      keep_default=False)
        ...
        # Adding field 'CatMolDescriptorPermitted.descriptor'
        db.add_column(u'DRP_catmoldescriptorpermitted', 'descriptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='permittedValues', to=orm['DRP.CatMolDescriptor']),
                      keep_default=False)

        # Adding field 'OrdMolDescriptorValue.descriptor'
        db.add_column(u'DRP_ordmoldescriptorvalue', 'descriptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.BoolMolDescriptor']),
                      keep_default=False)
        ...
        # Adding field 'CatMolDescriptorValue.descriptor'
        db.add_column(u'DRP_catmoldescriptorvalue', 'descriptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.CatMolDescriptor']),
                      keep_default=False)
