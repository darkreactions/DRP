...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compound.labGroup'
        db.add_column(u'DRP_compound', 'labGroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.LabGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compound.labGroup'
        db.delete_column(u'DRP_compound', 'labGroup_id')
