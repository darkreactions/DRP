...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'DRP_modelcontainer', (
            ...
            ('fully_trained', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.StatsModel'])),
        ))
        ...
        db.add_column(u'DRP_statsmodel', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['DRP.ModelContainer']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'StatsModel.splitter'
        db.add_column(u'DRP_statsmodel', 'splitter',
                      self.gf('django.db.models.fields.CharField')(default='Test Splitter', max_length=200),
                      keep_default=False)

        # Adding field 'StatsModel.tool'
        db.add_column(u'DRP_statsmodel', 'tool',
                      self.gf('django.db.models.fields.CharField')(default='svm', max_length=200),
                      keep_default=False)

        # Adding field 'StatsModel.library'
        db.add_column(u'DRP_statsmodel', 'library',
                      self.gf('django.db.models.fields.CharField')(default='weka', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        'DRP.modelcontainer': {
            ...
            'fully_trained': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.StatsModel']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
