...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TestSet.reaction'
        db.delete_column(u'DRP_testset', 'reaction_id')

        # Adding field 'TestSet.name'
        db.add_column(u'DRP_testset', 'name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 11, 1, 0, 0), max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TestSet.reaction'
        db.add_column(u'DRP_testset', 'reaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2015, 11, 1, 0, 0), to=orm['DRP.PerformedReaction'], on_delete=models.PROTECT),
                      keep_default=False)

        # Deleting field 'TestSet.name'
        db.delete_column(u'DRP_testset', 'name')
