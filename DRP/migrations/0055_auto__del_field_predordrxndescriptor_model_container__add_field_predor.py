...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding field 'PredOrdRxnDescriptor.stats_model'
        db.add_column(u'DRP_predordrxndescriptor', 'stats_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['DRP.StatsModel']),
                      keep_default=False)

        # Deleting field 'PredNumRxnDescriptor.model_container'
        db.delete_column(u'DRP_prednumrxndescriptor', 'model_container_id')

        # Adding field 'PredNumRxnDescriptor.stats_model'
        db.add_column(u'DRP_prednumrxndescriptor', 'stats_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['DRP.StatsModel']),
                      keep_default=False)

        # Deleting field 'PredCatRxnDescriptor.model_container'
        db.delete_column(u'DRP_predcatrxndescriptor', 'model_container_id')

        # Adding field 'PredCatRxnDescriptor.stats_model'
        db.add_column(u'DRP_predcatrxndescriptor', 'stats_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['DRP.StatsModel']),
                      keep_default=False)

        # Deleting field 'PredBoolRxnDescriptor.model_container'
        db.delete_column(u'DRP_predboolrxndescriptor', 'model_container_id')

        # Adding field 'PredBoolRxnDescriptor.stats_model'
        db.add_column(u'DRP_predboolrxndescriptor', 'stats_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['DRP.StatsModel']),
                      keep_default=False)
