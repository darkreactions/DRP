...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BoolMolDescriptorValue'
        db.create_table(u'DRP_boolmoldescriptorvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descriptor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.BoolMolDescriptor'])),
        ...
        db.send_create_signal('DRP', ['BoolMolDescriptorValue'])
        ...
        # Adding model 'NumMolDescriptorValue'
        db.create_table(u'DRP_nummoldescriptorvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descriptor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.BoolMolDescriptor'])),
            ('compound', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Compound'])),
            ('value', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal('DRP', ['NumMolDescriptorValue'])
        ...
        # Adding model 'OrdMolDescriptorValue'
        db.create_table(u'DRP_ordmoldescriptorvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descriptor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.BoolMolDescriptor'])),
            ('compound', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Compound'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('DRP', ['OrdMolDescriptorValue'])
        ...
        # Adding model 'CatMolDescriptorValue'
        db.create_table(u'DRP_catmoldescriptorvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descriptor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.CatMolDescriptor'])),
            ('compound', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.Compound'])),
            ('value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.CatMolDescriptorPermitted'])),
        ))
        db.send_create_signal('DRP', ['CatMolDescriptorValue'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BoolMolDescriptorValue'
        db.delete_table(u'DRP_boolmoldescriptorvalue')

        # Deleting model 'NumMolDescriptor'
        db.delete_table(u'DRP_nummoldescriptor')

        # Deleting model 'NumMolDescriptorValue'
        db.delete_table(u'DRP_nummoldescriptorvalue')
        ...
        # Deleting model 'OrdMolDescriptorValue'
        db.delete_table(u'DRP_ordmoldescriptorvalue')

        # Deleting model 'CatMolDescriptorValue'
        db.delete_table(u'DRP_catmoldescriptorvalue')


    models = {
        'DRP.boolmoldescriptor': {
            'Meta': {'unique_together': "(('heading', 'calculatorSoftware', 'calculatorSoftwareVersion'),)", 'object_name': 'BoolMolDescriptor'},
        ...
        'DRP.boolmoldescriptorvalue': {
            ...
            'descriptor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.BoolMolDescriptor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        },
        'DRP.catmoldescriptor': {
            'Meta': {'unique_together': "(('heading', 'calculatorSoftware', 'calculatorSoftwareVersion'),)", 'object_name': 'CatMolDescriptor'},
            'calculatorSoftware': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'calculatorSoftwareVersion': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'heading': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'DRP.catmoldescriptorpermitted': {
            ...
            'descriptor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'permittedValues'", 'to': "orm['DRP.CatMolDescriptor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'DRP.catmoldescriptorvalue': {
            'Meta': {'unique_together': "(('descriptor', 'compound'),)", 'object_name': 'CatMolDescriptorValue'},
            'compound': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.Compound']"}),
            'descriptor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.CatMolDescriptor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'DRP.nummoldescriptor': {
            'Meta': {'unique_together': "(('heading', 'calculatorSoftware', 'calculatorSoftwareVersion'),)", 'object_name': 'NumMolDescriptor'},
            'calculatorSoftware': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'calculatorSoftwareVersion': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'heading': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'DRP.ordmoldescriptor': {
            'Meta': {'unique_together': "(('heading', 'calculatorSoftware', 'calculatorSoftwareVersion'),)", 'object_name': 'OrdMolDescriptor'},
            'calculatorSoftware': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'calculatorSoftwareVersion': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'heading': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
