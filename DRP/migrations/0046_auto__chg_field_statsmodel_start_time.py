...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StatsModel.start_time'
        db.alter_column(u'DRP_statsmodel', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'StatsModel.start_time'
        db.alter_column(u'DRP_statsmodel', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 11, 1, 0, 0)))
