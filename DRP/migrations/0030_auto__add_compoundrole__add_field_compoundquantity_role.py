...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompoundRole'
        db.create_table(u'DRP_compoundrole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('DRP', ['CompoundRole'])

        # Adding field 'CompoundQuantity.role'
        db.add_column(u'DRP_compoundquantity', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.CompoundRole']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CompoundRole'
        db.delete_table(u'DRP_compoundrole')

        # Deleting field 'CompoundQuantity.role'
        db.delete_column(u'DRP_compoundquantity', 'role_id')
