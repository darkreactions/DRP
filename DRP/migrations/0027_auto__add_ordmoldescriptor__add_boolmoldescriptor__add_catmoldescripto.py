...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'DRP_catmoldescriptorpermitted', (
            (u'categoricaldescriptorpermittedvalue_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DRP.CategoricalDescriptorPermittedValue'], unique=True, primary_key=True)),
        ))
        ...
        db.create_table(u'DRP_catmoldescriptor', (
            (u'categoricaldescriptor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DRP.CategoricalDescriptor'], unique=True, primary_key=True)),
        ))
    ...
    models = {
        ...
        'DRP.catmoldescriptorpermitted': {
            'Meta': {'object_name': 'CatMolDescriptorPermitted', '_ormbases': ['DRP.CategoricalDescriptorPermittedValue']},
            u'categoricaldescriptorpermittedvalue_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['DRP.CategoricalDescriptorPermittedValue']", 'unique': 'True', 'primary_key': 'True'})
        },
