...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompoundQuantity.amountUnit'
        db.delete_column(u'DRP_compoundquantity', 'amountUnit')

        # Deleting field 'Reaction.purity'
        db.delete_column(u'DRP_reaction', 'purity')

        # Deleting field 'Reaction.temp'
        db.delete_column(u'DRP_reaction', 'temp')

        # Deleting field 'Reaction.leak'
        db.delete_column(u'DRP_reaction', 'leak')

        # Deleting field 'Reaction.time'
        db.delete_column(u'DRP_reaction', 'time')

        # Deleting field 'Reaction.slowCool'
        db.delete_column(u'DRP_reaction', 'slowCool')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CompoundQuantity.amountUnit'
        raise RuntimeError("Cannot reverse this migration. 'CompoundQuantity.amountUnit' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Reaction.purity'
        raise RuntimeError("Cannot reverse this migration. 'Reaction.purity' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Reaction.temp'
        raise RuntimeError("Cannot reverse this migration. 'Reaction.temp' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Reaction.leak'
        raise RuntimeError("Cannot reverse this migration. 'Reaction.leak' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Reaction.time'
        raise RuntimeError("Cannot reverse this migration. 'Reaction.time' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Reaction.slowCool'
        raise RuntimeError("Cannot reverse this migration. 'Reaction.slowCool' and its values cannot be restored.")
