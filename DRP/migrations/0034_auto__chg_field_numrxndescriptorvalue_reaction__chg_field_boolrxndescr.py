...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NumRxnDescriptorValue.reaction'
        db.alter_column(u'DRP_numrxndescriptorvalue', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.Reaction']))

        # Changing field 'BoolRxnDescriptorValue.reaction'
        db.alter_column(u'DRP_boolrxndescriptorvalue', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.Reaction']))

        # Changing field 'OrdRxnDescriptorValue.reaction'
        db.alter_column(u'DRP_ordrxndescriptorvalue', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.Reaction']))

        #delete table to prevent errors
        db.delete_table(u'DRP_catrxndescriptor')

        #recreate table
        db.create_table(u'DRP_catrxndescriptor', (
                      (u'categoricaldescriptor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['DRP.CategoricalDescriptor'], 
                      unique=True, primary_key=True)),
        ))
        
        db.send_create_signal('DRP', 'CatRxnDescriptor')

        # Changing field 'CatRxnDescriptorValue.reaction'
        db.alter_column(u'DRP_catrxndescriptorvalue', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DRP.Reaction']))
