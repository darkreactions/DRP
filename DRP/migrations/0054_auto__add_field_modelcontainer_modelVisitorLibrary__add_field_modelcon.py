...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelContainer.modelVisitorLibrary'
        db.add_column(u'DRP_modelcontainer', 'modelVisitorLibrary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ModelContainer.modelVisitorTool'
        db.add_column(u'DRP_modelcontainer', 'modelVisitorTool',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelContainer.modelVisitorLibrary'
        db.delete_column(u'DRP_modelcontainer', 'modelVisitorLibrary')

        # Deleting field 'ModelContainer.modelVisitorTool'
        db.delete_column(u'DRP_modelcontainer', 'modelVisitorTool')
    ...
    models = {
        ...
        'DRP.modelcontainer': {
            ...
            'modelVisitorLibrary': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'modelVisitorTool': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
