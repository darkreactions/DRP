...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field chemicalClasses on 'Compound'
        db.create_table(u'DRP_compound_chemicalClasses', (
        ...
        db.create_unique(u'DRP_compound_chemicalClasses', ['compound_id', 'chemicalclass_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field chemicalClasses on 'Compound'
        db.delete_table('DRP_compound_chemicalClasses')
