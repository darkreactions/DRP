...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Compound.CAS_ID'
        db.delete_column(u'DRP_compound', 'CAS_ID')

        # Deleting field 'Compound.CHEBI_ID'
        db.delete_column(u'DRP_compound', 'CHEBI_ID')


    def backwards(self, orm):
        # Adding field 'Compound.CAS_ID'
        db.add_column(u'DRP_compound', 'CAS_ID',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=13, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Compound.CHEBI_ID'
        raise RuntimeError("Cannot reverse this migration. 'Compound.CHEBI_ID' and its values cannot be restored.")
