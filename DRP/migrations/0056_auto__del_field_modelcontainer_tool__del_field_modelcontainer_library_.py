...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ModelContainer.tool'
        db.delete_column(u'DRP_modelcontainer', 'tool')

        # Deleting field 'ModelContainer.library'
        db.delete_column(u'DRP_modelcontainer', 'library')

        # Adding field 'ModelContainer.featureLibrary'
        db.add_column(u'DRP_modelcontainer', 'featureLibrary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ModelContainer.featureTool'
        db.add_column(u'DRP_modelcontainer', 'featureTool',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ModelContainer.tool'
        db.add_column(u'DRP_modelcontainer', 'tool',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ModelContainer.library'
        db.add_column(u'DRP_modelcontainer', 'library',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'ModelContainer.featureLibrary'
        db.delete_column(u'DRP_modelcontainer', 'featureLibrary')

        # Deleting field 'ModelContainer.featureTool'
        db.delete_column(u'DRP_modelcontainer', 'featureTool')
