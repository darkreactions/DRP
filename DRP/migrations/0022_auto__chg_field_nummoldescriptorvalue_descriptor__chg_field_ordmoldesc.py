...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'DRP_ordmoldescriptorvalue', 'descriptor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.NumMolDescriptor']))

    def backwards(self, orm):

        # Changing field 'NumMolDescriptorValue.descriptor'
        db.alter_column(u'DRP_nummoldescriptorvalue', 'descriptor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.BoolMolDescriptor']))

        # Changing field 'OrdMolDescriptorValue.descriptor'
        db.alter_column(u'DRP_ordmoldescriptorvalue', 'descriptor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DRP.BoolMolDescriptor']))
    ...
    models = {
        ...
        'DRP.nummoldescriptor': {
            'Meta': {'object_name': 'NumMolDescriptor', '_ormbases': ['DRP.MolDescriptor']},
        ...
        'DRP.nummoldescriptorvalue': {
            ...
            'compound': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.Compound']"}),
            'descriptor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DRP.NumMolDescriptor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
