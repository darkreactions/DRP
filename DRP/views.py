 ...
 if request.method == 'POST' and u.is_authenticated():
  ...
  if changesMade["type"]=="del":
   ...
   try:
    ...
    if changed_entry.compound_type=="Inorg" and changed_entry.smiles=="":
