...
NumRxnDescValFormSet = modelformset_factory(NumRxnDescriptorValue, form=NumRxnDescValForm, can_delete=True, prefix='num')
OrdRxnDescValFormSet = modelformset_factory(OrdRxnDescriptorValue, form=OrdRxnDescValForm, can_delete=True, prefix='ord')
BoolRxnDescValFormSet = modelformset_factory(BoolRxnDescriptorValue, form=BoolRxnDescValForm, can_delete=True, prefix='bool')
CatRxnDescValFormSet = modelformset_factory(CatRxnDescriptorValue, form=CatRxnDescValForm, can_delete=True, prefix='cat')
