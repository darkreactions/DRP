...
COMMENT="Legacy rxns. New descriptors including cxcalc nonzero variance. 1 mutual info split."
FILE_SUFFIX="legRxnNonZeroCompound_NewCXDscNonZeroVar_1MISPLIT"
