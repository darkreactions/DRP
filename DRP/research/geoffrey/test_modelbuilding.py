...
for modelVisitorLibrary, module in visitorModules.items():
    for modelVisitorTool in module.tools:
        for splitter in settings.REACTION_DATASET_SPLITTERS:
            ...
            prepare_build_display_model(descriptor_headers=descriptor_headers, response_headers=response_headers, modelVisitorLibrary=modelVisitorLibrary, modelVisitorTool=modelVisitorTool, splitter=splitter, verbose=False)
