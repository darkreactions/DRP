...
DESCRIPTOR_FILE="descs/CFS_legRxnNonZeroCompound_NewDscRxnpHCANonzeroVar.dsc"
OUTCOME_DESCRIPTOR="boolean_outcome_legacy"
RXN_SET_NAME="valid_legacy_rxns_nonzero_compound"
COMMENT="Legacy rxns. CFS of new and legacy descriptors with only New ChemAxon. 15 mutual info split."
FILE_SUFFIX="legRxnNonZeroCompound_CFSNewRxnpHCA_15MISplit"
