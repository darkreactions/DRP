...
COMMENT="Legacy rxns. Legacy descriptors with ChemAxon nonzero InfoGain. 15 mutual info split."
FILE_SUFFIX="legRxnNonZeroCompound_LegDscCANonzeroInfo_15MISplit"
