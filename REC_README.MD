...
### Note: Before you _commit_ you need to type the commands ```git config --local user.name "YOUR GITHUB USERNAME HERE"``` and ```git config --local user.email <THE EMAIL YOU USED TO SIGN UP TO GITHUB WITH>```
