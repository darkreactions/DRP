...
Once you login to mysql, and create two databases:
  'CREATE DATABASE DRP[a] CHARACTER SET utf8 COLLATE utf8_bin;'
...
STEP 6: Installing Chemaxon (optional)[b]
...
1. templates (The HTML templates for Django Views.)
2. research (Any "research" scripts that are still being explored.)
3. static (Any static files for which Django can skip templating.)
* favicon.ico        -- The "favicon" for the site (actually served by NGINX).
1. js/        -- Any Javascript for any view belongs in this directory. universal.js -- Contains Javascript used on nearly every page.
...
5. admin/        -- CSS for the /admin/ page. Used in many django installations.
...
[a]reset default name to this and DRP_test also uncomment l109
[b]?
[c]Vague instruction is vague, but the git documentation is very clear with this in general...
